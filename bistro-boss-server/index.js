...
// mongodb://bossUser:gvLxuipYkFsCgWYZ@localhost:27017/bistroDB?authSource=admin

const uri = `mongodb://${process.env.DB_USER}:${process.env.DB_PASS}@mongo:27017/bistroDb?authSource=admin`;
...
async function run() {
  try {
    ...
    app.post("/success-payment", async(req,res)=>{
      ...
      res.redirect('http://localhost:4173/dashboard/paymentHistory');
